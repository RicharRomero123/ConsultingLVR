...
export type FrameworkProgramacion = 
    | 'SPRING_BOOT' 
    | 'REACT' 
    | 'ANGULAR' 
    | 'VUE_JS' 
...
export interface Service {
    ...
    activo: boolean;    
    tiempoEsperaMinutos: number; // Tiempo de espera en minutos
    imgUrl: string; // URL de la imagen del servicio
    enlace: string; // Enlace al proyecto o repositorio
    detalles: {
        rubro: string; // Rubro del servicio (ej. "Desarrollo Web")
        tipoDeSoftware: string; // Tipo de software (ej. "Sistema Web")
        lenguaje: ProgrammingLanguage; // Lenguaje de programación
        framework: FrameworkProgramacion; // Framework utilizado
    };
}
